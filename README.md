...
```
https://raw.githubusercontent.com/OsmerGalarragaTKD/aniyomi-ext/repo/repo/index.min.json
```
...
https://github.com/OsmerGalarragaTKD/aniyomi-ext/tree/repo/repo/apk
